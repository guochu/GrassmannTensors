...
struct TruncationSpace <: TruncationScheme
    space::GradedSpace
end
truncspace(space::GradedSpace) = TruncationSpace(space)
...
# auxiliary function
function _findnexttruncvalue(Σdata, truncdim::SectorDict{I,Int}, p::Real) where {I}
    # early return
...
function _findnextgrowvalue(Σdata, truncdim::SectorDict{I,Int}, p::Real) where {I}
